...
})({"liXIl":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "adf01eb55c36a587";
"use strict";
...
},{}],"70l0Z":[function(require,module,exports) {
var _adapter = require("@nitipit/adapter/src/adapter");
var _color = require("../color");
class ID_Header extends (0, _adapter.Adapter) {
}
(0, _adapter.define)("id-header", ID_Header);
ID_Header.tagStyle(`
    display: flex;
    flex-wrap: wrap;
    justify-content: center;
    background-color: ${(0, _color.color).p3};
    color: white;
    .container {
        width: 90%;
        max-width: 600px;
...
},{"@nitipit/adapter/src/adapter":"lAEBj","../color":"9for5"}],"lAEBj":[function(require,module,exports) {
...
var _addStyle = require("./add-style");
...
class Adapter extends HTMLElement {
    ...
    static classStyle(class_, style) {
        if (typeof style == "string") (0, _addStyle.addStyle)`
            ${this.tagName}.${class_} {
                ${style}
            }`;
        else if (typeof style == "object") (0, _addStyle.addStyle)`
            ${this.tagName}.${class_} {
                ${this.Style.style(style)}
            }`;
    }
    ...
    addStyle(style) {
        ...
        else if (typeof style == "object") className = (0, _css.css)`${this._class.Style.style(style)}`;
...
},{"@emotion/css":"gyRZs","./add-style":"iyzOn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gyRZs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@emotion/cache":"3Umtj","@emotion/serialize":"kS2E2","@emotion/utils":"6UI8e","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iyzOn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addStyle", ()=>(0, _css.injectGlobal));
var _css = require("@emotion/css");

},{"@emotion/css":"gyRZs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9for5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["liXIl","70l0Z"], "70l0Z", "parcelRequire710c")

//# sourceMappingURL=id-header.js.map

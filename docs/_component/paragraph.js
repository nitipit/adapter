...
(0, _adapter.define)("el-paragraph", Paragraph);
Paragraph.tagStyle(`
    .container {
        max-width: 45rem;
        width: 90%;
    ...
    h2 + hr {
        ...
        ${(0, _bgColor.bgColor)((0, _color.color).p2)}
    }
    ...
    blockquote {
        ...
        padding: 0;
        padding-left: 1rem;
        border-left: 5px solid ${(0, _color.color).p2};
    }
...
},{"@nitipit/adapter/src/adapter":"lAEBj","gadjet/src/style/bg-color":"celAt","../color":"9for5"}],"lAEBj":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iDz6z","3dOKP"], "3dOKP", "parcelRequire710c")
